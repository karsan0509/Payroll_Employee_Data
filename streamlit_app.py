...
with st.form("payroll_form"):
    ...
    with col2:
        ...
        basic = st.number_input("Basic", min_value=0, max_value=1000000, value=int(fields["basic"]))
        hra = st.number_input("HRA", min_value=0, max_value=1000000, value=int(fields["hra"]))
        special = st.number_input("Special Allowance", min_value=0, max_value=1000000, value=int(fields["special"]))
        bonus = st.number_input("Bonus", min_value=0, max_value=1000000, value=int(fields["bonus"]))
        pf = st.number_input("PF",min_value=0, max_value=1000000, value=int(fields["pf"]))
        tax = st.number_input("Pro Tax", min_value=0, max_value=1000000, value=int(fields["tax"]))
        snacks = st.number_input("Snacks", min_value=0, max_value=1000000, value=int(fields["snacks"]))
        bus = st.number_input("Bus", min_value=0, max_value=1000000, value=int(fields["bus"]))
        loan = st.number_input("Loan", min_value=0, max_value=1000000, value=int(fields["loan"]))
